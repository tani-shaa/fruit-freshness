...
def load_or_create_model():
    """
    Load the saved model if it exists, otherwise return a fresh untrained model.

    Resolution order:
      1. freshness_model.keras  — native Keras v3 format (TF 2.12+)
      2. build_model()          — fresh untrained model when no file exists
    """
    ...
    # No model on disk — return untrained skeleton
    return build_model()
